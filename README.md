...
[直接下载 MouseGestureStudio-Setup-0.2.2.exe](https://github.com/liaozhu913/MouseGestureStudio/releases/latest/download/MouseGestureStudio-Setup-0.2.2.exe)
...
2. 下载 `MouseGestureStudio-Setup-0.2.2.exe`。
3. 双击安装包完成安装。
